const TOPICS = [
  // Modern Solutions
  { id: "parallelism", chapter: "modern-solutions", title: "Parallelism & Flynn's Taxonomy", description: "Levels of parallelism and how we classify architectures", icon: "grid" },
  { id: "pipelining", chapter: "modern-solutions", title: "Pipelining & Hazards", description: "How the pipeline works, what can go wrong, and how to fix it", icon: "layers" },
  { id: "ooo-execution", chapter: "modern-solutions", title: "Out-of-Order Execution & Register Renaming", description: "Reordering instructions and eliminating false dependencies", icon: "shuffle" },
  { id: "branch-prediction", chapter: "modern-solutions", title: "Branch Prediction & Speculative Execution", description: "Guessing branch outcomes to keep the pipeline full", icon: "git-branch" },
  { id: "superscalar-vliw", chapter: "modern-solutions", title: "Superscalar & VLIW", description: "Multiple instructions per cycle: hardware vs compiler approach", icon: "zap" },
  { id: "vector-processors", chapter: "modern-solutions", title: "Vector / SIMD Processors", description: "Processing multiple data elements with one instruction", icon: "cpu" },
  { id: "multicore", chapter: "modern-solutions", title: "Multi-core, Hyper-threading & GPU", description: "Parallel processing with multiple cores and GPUs", icon: "server" },
  { id: "fpga-numa", chapter: "modern-solutions", title: "FPGA & NUMA", description: "Reconfigurable hardware and non-uniform memory access", icon: "box" },
  { id: "performance", chapter: "modern-solutions", title: "Performance (Amdahl's Law)", description: "Measuring speed and the limits of parallelism", icon: "trending-up" },
  // Cache
  { id: "cache-basics", chapter: "cache", title: "Why Cache & Locality", description: "The speed gap problem and how locality makes cache work", icon: "database" },
  { id: "cache-structure", chapter: "cache", title: "Cache Structure & Operation", description: "Lines, tags, flags, and how a cache lookup works", icon: "layout" },
  { id: "cache-associativity", chapter: "cache", title: "Associativity & Replacement", description: "Where data can go in cache and what gets evicted", icon: "columns" },
  { id: "cache-write", chapter: "cache", title: "Write Policies & Dirty Bit", description: "Write-through vs write-back and tracking modifications", icon: "edit" },
  { id: "cache-address", chapter: "cache", title: "Address Calculations", description: "Tag, index, offset decomposition and cache math", icon: "hash" },
  { id: "cache-coherence", chapter: "cache", title: "Cache Hierarchy & Coherence (MESI)", description: "Multi-level caches and keeping data consistent across cores", icon: "link" },
  { id: "cache-programming", chapter: "cache", title: "Cache & Programming", description: "How cache affects code performance: arrays, matrices, access patterns", icon: "code" }
];

// Maps existing subcategory values to topic IDs
const SUBCATEGORY_TO_TOPIC = {
  "parallelism": "parallelism",
  "pipelining": "pipelining",
  "ooo-execution": "ooo-execution",
  "branch-prediction": "branch-prediction",
  "superscalar": "superscalar-vliw",
  "vliw": "superscalar-vliw",
  "vector-processors": "vector-processors",
  "loop-unrolling": "superscalar-vliw",
  ...
  "locality": "cache-basics",
  "basics": "cache-basics",
  "structure": "cache-structure",
  "operation": "cache-structure",
  "associativity": "cache-associativity",
  "replacement": "cache-associativity",
  "write-policy": "cache-write",
  "address-structure": "cache-address",
  "hierarchy": "cache-coherence",
  "coherence": "cache-coherence",
  "programming": "cache-programming"
};
